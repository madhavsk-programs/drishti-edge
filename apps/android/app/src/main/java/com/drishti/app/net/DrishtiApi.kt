...
interface DrishtiApi {
    ...
    @POST("api/v1/monitor/telemetry")
    suspend fun sendMonitorTelemetry(
        @Header("X-Drishti-Key") accessKey: String,
        @Body request: MonitorTelemetryRequest,
    ): Response<MonitorTelemetryAck>
